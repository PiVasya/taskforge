...
8. targetSkillsAtAnchor и bridgePlan относятся ТОЛЬКО к выбранному anchor-заданию. Не добавляй в bridgePlan навыки, которые нужны лишь для более поздних rejected candidate gaps. Если видишь полезный мост для более поздней группы, упомяни его в placementCandidates/reason, но не генерируй draft для него в текущей точке.

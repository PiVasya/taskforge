...
# Once the user's current migrations have been returned, freeze that exact model and migration set.
if (ROOT / 'docs/sql/user-20260923-protected.sha256').is_file():

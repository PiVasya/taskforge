...
expect('services/identity/api/Services/Users/ProfileService.cs', browser=False, frontend=False, oj=False, repo_migrations=True)
...
expect('scripts/ci/check-ef-migrations.py', repo_migrations=True)
expect('services/tasks/assignment-api/Services/Access/CourseMapProjectionService.cs', repo_migrations=True)
expect('services/bots/telegram-quiz-bot/Program.cs', repo_migrations=True)
expect('Directory.Build.props', repo_migrations=True)

...
OVERRIDES = {
    ...
    "HA_ENABLED", "HA_NODE_ID", "HA_PREFERRED_NODE", "HA_WG_CIDR", "HA_WG_IP", "HA_PEER_WG_IP", "HA_NODE_A_PUBLIC_IP", "HA_NODE_B_PUBLIC_IP",
    "HA_AGENT_BIND", "HA_AGENT_PORT", "HA_AUTO_FAILOVER", "HA_AUTO_FAILBACK",
    "HA_FAILOVER_AFTER_SECONDS", "HA_SERVICE_FAILOVER_AFTER_SECONDS", "HA_FAILBACK_DELAY_SECONDS",
    "HA_FAILBACK_STABLE_SECONDS", "HA_FAILBACK_MAX_LAG_BYTES", "HA_REJOIN_AFTER_SECONDS",
    "HA_LOOP_SECONDS", "HA_OPERATION_TIMEOUT_SECONDS", "HA_GATEWAY_READY_TIMEOUT_SECONDS", "HA_MINIO_DRAIN_TIMEOUT_SECONDS",
    "HA_FENCE_SCRIPT", "HA_RECOVER_SCRIPT", "HA_ALLOW_UNFENCED_FAILOVER",

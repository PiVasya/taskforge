...
def build_chat_turn_prompt(job: Dict[str, Any], payload: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "ВАЖНО: Возвращай строго ОДИН action за ход. Никогда не возвращай один и тот же action дважды. Два разных action в одном ходе допустимы только если это полностью независимые операции, не связанные между собой причинно. "

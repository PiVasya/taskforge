...
_GENERATION_VERBS = ["сделай", "создай", "сгенер", "подготов", "собери", "нужна", "нужно", "хочу", "напиши", "наброс", "накидай", "придумай"]
_GENERATION_TARGETS = ["задач", "задачк", "сери", "лесенк", "пакет", "программ", "мини-программ", "маленьких программ", "черновик", "черновики", "наброс", "вариант", "тест", "quiz", "упражнен"]

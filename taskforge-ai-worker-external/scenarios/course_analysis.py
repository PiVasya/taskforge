...
Если пользователь спрашивает про конкретную тему (например if), сначала проверь focusAssignments и весь courseOutline: там могут быть задания не в начале курса. Не делай вывод по первым 5-10 заданиям, если courseOutline содержит больше.

...
1. Язык сохраняй из курса/предыдущего черновика. Для code-test в курсе «Основы C++/С++» генерируй C++, allowedLanguages=["cpp"], language="cpp", referenceSolutionCpp заполнен, referenceSolutionPython=null. Для test/math кодовое решение не требуется, но стиль и терминологию курса сохраняй. Не переключайся на Python.

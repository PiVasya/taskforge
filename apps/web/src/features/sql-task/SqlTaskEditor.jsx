...
const SqlTaskEditor = forwardRef(function SqlTaskEditor({ assignmentId, onPublished }, ref) {
  ...
  return <div className="sql-task">
    ...
    <div className="sql-card"><div className="sql-toolbar"><h3>Движки и проверка</h3><SqlHelp label="Справка по режимам проверки"><p>SQL-команды выполняются по порядку до первой ошибки. В режиме результата сравнивается последний набор строк. Транзакционное администрирование сервера и внешние файлы недоступны.</p></SqlHelp></div>

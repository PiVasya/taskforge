...
namespace TaskForge.Identity.Api.Migrations
{
    ...
    [Migration("20260923100059_AddRoleHierarchy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskForge.Identity.Api.Domain.BlockedAccount", b =>
                {
            ...
            modelBuilder.Entity("TaskForge.Identity.Api.Domain.FeatureRole", b =>
                {
                    ...
                    b.ToTable("FeatureRoles", null, t =>
                        {
                            t.HasCheckConstraint("CK_FeatureRoles_Rank_NonNegative", "\"Rank\" >= 0");
                        });
                });

...
""";
    ...
    private static string GetActionTitle(string action) => action switch
    {
        ...
        "investigate_support_ticket" => "собрать контекст обращения",
        "get_support_chat" => "прочитать чат поддержки",
        "get_user_recent_activity" => "посмотреть активность пользователя",
        "list_user_solutions" => "получить индекс решений",
        "get_solution" => "открыть решение",
        "get_assignment" => "открыть задание",

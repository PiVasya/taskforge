...
namespace taskforge.Migrations
{
    ...
    [Migration("20260426170732_AddHiddenAiDraftAssignments")]
    partial class AddHiddenAiDraftAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("ActingOnBehalfOfUserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("NextWakeAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ActingOnBehalfOfUserId");
                    ...
                    b.HasIndex("Status", "NextWakeAtUtc");

                    b.ToTable("AgentRuns");
                });

            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentRunArtifact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AgentRunArtifacts");
                });

            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.TaskAssignment", b =>
                {
                    ...
                    b.Property<DateTime?>("PolishedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("SourceAgentArtifactId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("SourceAgentRunId")
                        .HasColumnType("uuid");

                    b.Property<int?>("SourceAgentTaskIndex")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentConversation", b =>
                {
                    ...
                    b.HasOne("taskforge.Data.Models.Entities.SupportTicket", "SupportTicket")
                        .WithMany()
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentMessage", b =>
                {
                    b.HasOne("taskforge.Data.Models.Entities.AgentConversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("taskforge.Data.Models.Entities.AgentRun", "Run")
                        .WithMany()
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.AgentRun", b =>
                {
                    b.HasOne("taskforge.Data.Models.Entities.User", "ActingOnBehalfOfUser")
                        .WithMany()
                        .HasForeignKey("ActingOnBehalfOfUserId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ActingOnBehalfOfUser");
            ...
            modelBuilder.Entity("taskforge.Data.Models.Entities.TaskAssignment", b =>
                {
                    ...
                    b.HasOne("taskforge.Data.Models.Entities.AgentRunArtifact", "SourceAgentArtifact")
                        .WithMany()
                        .HasForeignKey("SourceAgentArtifactId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("taskforge.Data.Models.Entities.AgentRun", "SourceAgentRun")
                        .WithMany()
                        .HasForeignKey("SourceAgentRunId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Course");

                    b.Navigation("SourceAgentArtifact");

                    b.Navigation("SourceAgentRun");
                });

...
namespace taskforge.Migrations
{
    ...
    [Migration("20250920191603_AddedCourses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskTestCase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserTaskSolution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Course", b =>
                {
                    b.HasOne("taskforge.Data.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskTestCase", b =>
                {
                    b.HasOne("TaskAssignment", "TaskAssignment")
                        .WithMany("TestCases")
            ...
            modelBuilder.Entity("UserTaskSolution", b =>
                {
                    ...
                    b.HasOne("taskforge.Data.Models.User", "User")
                        .WithMany()
